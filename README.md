...
This website uses Google Analytics to collect anonymized usage statistics. The information collected may include standard data such as Your device type, browser version, screen resolution, approximate geographic location, and time spent on the website. This data is transmitted to and stored by Google on servers located outside the European Union.
...
* Background video, shot by Film Composite and posted on Pexels for free use.
* Inter Typeface, designed by Rasmus Andersson and used under the MIT License.
* Text Scramble Animation, inspired by Justin Windle's public CodePen and used non-commercially.
* Liquid Glass Effect, adapted from publicly available code on Snipzy and used non-commercially.
* SF Compact Iconography, from the Apple Native CoreSVG 326 system and used for non-commercial purposes. All rights belong to Apple Incorporated.
